            ...
            <u-example title="尺寸">
                <template slot="case">
                    <fw-map ref="fwAmap" mapType="arcgis" @onMapLoad="onLoad" vid="esri_map" >
                        <fw-edit-layer @onEditInfo="onEditInfo">
                          <fw-point-layer :enableCluster="false" :enableEdit="true" :showInfoWindow="true" :symbol="symbol" vid="tollgateLayer" @onLayerClick="onLayerClick" @changeStandardModel="onChangeStandardModel" :source="dataList">
                          </fw-point-layer>
                        </fw-edit-layer>
                    </fw-map>
                </template>
