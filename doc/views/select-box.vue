<template>
    <l-generic>
        <div class="v-intro">
            ...
            <u-example title="尺寸">
                <template slot="case">
                  <i-button >张三</i-button>
                    <fw-map ref="fwAmap"  mapType="arcgis" @onMapLoad="onLoad" vid="esri_map" >
                      <fw-select-box @on-build="onSelectBoxBuild" @onCheckChanged="onCheckChanged">
                        <u-point-layer 
                        :enableCluster="false" 
                        :enableEdit="true" 
                        :showInfoWindow="true" 
                        :symbol="symbol" 
                        vid="tollgateLayer" 
                        @onLayerClick="onLayerClick" @changeStandardModel="onChangeStandardModel" :source="dataList">
                        </u-point-layer>
                      </fw-select-box>
                    </fw-map>
                </template>
